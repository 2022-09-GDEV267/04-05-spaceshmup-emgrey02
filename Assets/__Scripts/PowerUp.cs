...
public class PowerUp : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // the surface of the sphere witha  radius of 1m around the origin
        vel.z = 0; // flatten the vel to the xy plane
        vel.Normalize(); //makes it lenth 1m
    ...
    void Update()
    {
        ...
        {
            //if the PowerUp has driften entirely off screen, destroy it
            Destroy(gameObject);
        }
    }
    ...
    public void SetType(WeaponType wt)
    {
        ...
        //set color of cube child
        cubeRend.material.color = def.color;

        letter.color = def.color; //we could colorize letter too
        letter.text = def.letter; //set letter that's shown
